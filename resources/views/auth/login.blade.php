      ...
      <div class="card-body">
        ...
        <form action="{{ route('login') }}" method="post">
          ...
          <div class="input-group mb-3 ">
            <input type="text" class="form-control @error('usuario_codigo') is-invalid @enderror" placeholder="Usuario Código"
                id="usuario_codigo" name="usuario_codigo">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-user"></span>
              </div>
            </div>
            @error('usuario_codigo')
